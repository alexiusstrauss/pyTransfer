...
class PessoaSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        lopessoa.setInicialBalance(value=genBalanceRandom())
        # Adiciona Token para transações
        lopessoa.setInicialToken(token=getnewtoken())
...
class HistorySerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        loDestinoForToken = Token.objects.get(
            codigo=validated_data.get('token_destino'))
